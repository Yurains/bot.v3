...
- 注意，該方法是基於堆疊記憶體的方式，所以他會開一個新的google頁面出來，每一次都會，盡可能的在搶票的時候，不要再開跟使用其他瀏覽器了，經測試，搶的過程，我開了其他的瀏覽器看yotube，他就死掉了。
---
## OCR 比較測試
...
6. **KKITX地區的選擇** -這是個Beta版本而已，有時候會偵測不到，盡可能在搶票的不要再亂動其他瀏覽器。
